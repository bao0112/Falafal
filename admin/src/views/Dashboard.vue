...
function updateDashboard() {
    ...
    api.get(`/dashboard/customers-count`, { params: { d } }).then(({ data }) => {
        customersCount.value = data;
        loading.value.customersCount = false;
    });
    api.get(`/dashboard/products-count`, { params: { d } }).then(({ data }) => {
        productsCount.value = data;
        loading.value.productsCount = false;
    });
    api.get(`/dashboard/orders-count`, { params: { d } }).then(({ data }) => {
        paidOrders.value = data;
        loading.value.paidOrders = false;
    });
    api.get(`/dashboard/income-amount`, { params: { d } }).then(({ data }) => {
    ...
    // api.get(`/dashboard/orders-by-country`, { params: { d } }).then(({ data }) => {
    ...
    api.get(`/dashboard/latest-customers`, { params: { d } }).then(({ data: customers }) => {
        latestCustomers.value = customers;
        loading.value.latestCustomers = false;
    });
    api.get(`/dashboard/latest-orders`, { params: { d } }).then(({ data: orders }) => {
