<template>
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
        <div class="flex justify-between border-b-2 pb-3">
            ...
            <div class="flex items-center">
                <span>Found {{ orders.total }} orders</span>
            </div>
        </div>
                ...
                <tr v-for="(order, index) of orders.data">
                    ...
                    <td class="border-b p-2">
                        <router-link
                            ...
                            class="w-6 h-6 rounded-full text-blue-700 border border-blue-700 flex justify-center items-center hover:text-white hover:bg-blue-700"
                        >
                            <svg
