...
$defaultClasses = '';
$successClasses = 'border-blue-500 focus:border-blue-500 ring-1 ring-blue-500 focus:ring-blue-500';
...
<div>
    ...
    <select {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge([
        'class' => 'border-gray-300 focus:border-blue-600 focus:outline-none focus:ring-blue-500 rounded-md w-full ' .
